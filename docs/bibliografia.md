...
[23] R. Manhaeve, S. Dumancic, A. Kimmig, T. Demeester, and L. De Raedt, "DeepProbLog: Neural Probabilistic Logic Programming," NeurIPS 2018.
...
## Cómo usar las citas en la wiki

| Tema | Referencias principales |
|---|---|
| Panoramas NeSy | [1], [2], [5] |
| Taxonomía de Kautz | [7] |
| Planificación con LLMs | [8], [14], [16], [19] |
| Lógica formal con LLMs | [9], [18], [24] |
| Entrenamiento con restricciones lógicas | [10], [11], [12], [13], [23] |
| Geometría olímpica | [15], [21] |
| Ética y sesgo | [26] |

## Ver también

- [Ruta guiada](guia/index.md)
- [Evidencia empírica](guia/evidencia.md)
